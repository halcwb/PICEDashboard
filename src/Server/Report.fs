...
module Literals = Shared.Literals
                                ...
                                if c.Title <> chapterTitle then
                                    ...
                                    { c with
                                        Chapters =
                                            c.Chapters
                                            |> List.map (fun sc ->
                                                if sc.Title <> subTitle then
                                                    sc
                                                else
                                                    { sc with
                                                        Paragraphs =
                                                            { Title = title; Content = md }
                                                            |> List.singleton
...
let totalsTabel (tots: Totals) =
    [
        ...
        [
            Literals.capAllTimeMortality |> box
            calcPerc tots.Patients (float tots.Deaths) |> box
        ]
        [
            Literals.capHospitalMortality |> box
            calcPerc tots.Patients (float tots.HospitalDeaths) |> box
        ]
        [
            Literals.capPICUMortality |> box
            calcPerc tots.Admissions (float tots.PICUDeaths) |> box
        ]
        ...
        [
            Literals.capPRISM |> box
            calcPerc tots.Admissions tots.PRISM4Mortality |> box
        ]
...
let create (stats: Statistics) =
    ...
    let allYearTabel (stats: Statistics) =
        ...
        |> fun sb ->
            let sb =
                sb
                |> StringBuilder.appendLineFormat Markdown.Literals.columns9 caps
            ...
            |> fun sb ->
                ...
                sb
                |> StringBuilder.appendLineFormat Markdown.Literals.columns9 vals
                |> StringBuilder.toString
    ...
    |> addParagraph
        ...
        Literals.groupValidation
        Literals.paragraphTotals
        (printCount stats.Totals.InvalidPatients true)
    ...
    |> addParagraph
        ...
        Literals.paragraphPIMandPRISM
        "Op de x-as staan de actuele en geschatte mortaliteit"
    ...
    |> addSubParagraph
        ...
        Literals.paragraphTotals
        (printCount stats.Totals.DeathMode true)
    |> addSubParagraph
        Literals.sectionPICE
        Literals.groupMortality
        Literals.groupDeathMode
    ...
    |> addSubParagraph
        ...
        Literals.paragraphTotals
        (printCount stats.Totals.Gender true)
    |> addSubParagraph
        Literals.sectionPICE
        Literals.groupPatient
        Literals.groupGender
    ...
    |> addSubParagraph
        ...
        Literals.groupAge
        Literals.paragraphTotals
        (printCount stats.Totals.AgeGroup false)
    |> addSubParagraph
        Literals.sectionPICE
        Literals.groupPatient
        Literals.groupAge
    ...
    |> addSubParagraph
        Literals.sectionPICE
        Literals.groupAdmission
        Literals.subGroupTransportHospital
        Literals.paragraphTotals
        ""
    |> addSubParagraph
        Literals.sectionPICE
    ...
    |> addSubParagraph
        Literals.sectionPICE
        Literals.groupAdmission
        Literals.subGroupTransportTeam
        Literals.paragraphTotals
        ""
    |> addSubParagraph
        Literals.sectionPICE
    ...
    |> addSubParagraph
        ...
        Literals.paragraphTotals
        (printCount stats.Totals.DischargeReasons true)
    |> addSubParagraph
        Literals.sectionPICE
        Literals.groupDischarge
        Literals.groupDischargeReason
    ...
    |> addSubParagraph
        ...
        Literals.paragraphTotals
        (printCount stats.Totals.DiagnoseGroups true)
    |> addSubParagraph
        Literals.sectionPICE
        Literals.groupDiagnose
        Literals.groupDiagnoseGroup
    ...
    |> addSubParagraph
        ...
        Literals.paragraphTotals
        (printCount stats.Totals.Specialism true)
    |> addSubParagraph
        Literals.sectionPICE
        Literals.groupDiagnose
        Literals.groupSpecialism
